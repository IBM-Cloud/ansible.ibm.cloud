...
DOCUMENTATION = r'''
---
module: iam_access_groups_iam_access_group_rules_info
short_description: Manage iam_access_group_rules info.
author: IBM SDK Generator
version_added: "0.1"
description:
    - This module retrieves one or more iam_access_group_rules(s).
requirements:
    - "IamAccessGroupsV2"
options:
    rule_id:
