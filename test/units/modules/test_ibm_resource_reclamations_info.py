...
from ansible.modules.cloud.ibm import ibm_resource_reclamations_info
...
class TestReclamationsListModuleInfo(ModuleTestCase):
    ...
    def test_list_ibm_resource_reclamations_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_reclamations_info.ResourceControllerV2.list_reclamations')
        mock = patcher.start()
