...
from ansible.modules.cloud.ibm import ibm_resource_keys_info
...
class TestResourceKeysListModuleInfo(ModuleTestCase):
    ...
    def test_list_ibm_resource_keys_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_keys_info.ResourceControllerV2.list_resource_keys')
        mock = patcher.start()
    ...
    def test_list_ibm_resource_keys_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_keys_info.ResourceControllerV2.list_resource_keys')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='List ibm_resource_keys error')
