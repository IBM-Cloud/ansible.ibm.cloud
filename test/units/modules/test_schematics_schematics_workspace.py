...
from ansible.modules.cloud.ibm import schematics_schematics_workspace
...
class TestWorkspaceResponseModule(ModuleTestCase):
    ...
    def test_read_schematics_workspace_failed(self):
        """Test the inner "read" path in this module with a server error response."""

        patcher = patch('ansible.modules.cloud.ibm.schematics_schematics_workspace.SchematicsV1.get_workspace')
        mock = patcher.start()
        ...
        with self.assertRaises(AnsibleFailJson) as result:
            ...
            schematics_schematics_workspace.main()
    ...
    def test_create_schematics_workspace_success(self):
        """Test the "create" path - successful."""
        catalog_ref_model = dict(
            dry_run=True,
        ...
        dependencies_model = dict(
            parents=['testString'],
            children=['testString'],
        )

        shared_target_data_model = dict(
        ...
        environment_values_metadata_model = dict(
            hidden=True,
            name='testString',
            secure=True,
        )

        inject_terraform_template_inner_tft_parameters_item_model = dict(
            name='testString',
            value='testString',
        )

        inject_terraform_template_inner_model = dict(
        ...
        workspace_variable_request_model = dict(
        ...
        template_source_data_request_model = dict(
            env_values=[{ 'foo': 'bar' }],
        ...
        template_repo_request_model = dict(
            branch='testString',
            release='testString',
        ...
        workspace_status_request_model = dict(
            frozen=True,
            frozen_at='2019-01-01T12:00:00Z',
            frozen_by='testString',
            locked=True,
            locked_by='testString',
            locked_time='2019-01-01T12:00:00Z',
        )
        ...
        patcher = patch('ansible.modules.cloud.ibm.schematics_schematics_workspace.SchematicsV1.create_workspace')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)

        get_workspace_patcher = patch('ansible.modules.cloud.ibm.schematics_schematics_workspace.SchematicsV1.get_workspace')
    ...
    def test_create_schematics_workspace_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.schematics_schematics_workspace.SchematicsV1.create_workspace')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='Create schematics_workspace error')
        ...
        assert result.exception.args[0]['msg'] == 'Create schematics_workspace error'
    ...
    def test_update_schematics_workspace_success(self):
        ...
        template_repo_update_request_model = dict(
            branch='testString',
            release='testString',
            repo_sha_value='testString',
            repo_url='testString',
        ...
        workspace_status_update_request_model = dict(
            frozen=True,
            frozen_at='2019-01-01T12:00:00Z',
            frozen_by='testString',
            locked=True,
        ...
        workspace_status_message_model = dict(
        ...
        patcher = patch('ansible.modules.cloud.ibm.schematics_schematics_workspace.SchematicsV1.update_workspace')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)
    ...
    def test_update_schematics_workspace_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.schematics_schematics_workspace.SchematicsV1.update_workspace')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='Update schematics_workspace error')
        ...
        assert result.exception.args[0]['msg'] == 'Update schematics_workspace error'
    ...
    def test_delete_schematics_workspace_success(self):
        """Test the "delete" path - successfull."""
        patcher = patch('ansible.modules.cloud.ibm.schematics_schematics_workspace.SchematicsV1.delete_workspace')
        mock = patcher.start()
    ...
    def test_delete_schematics_workspace_not_exists(self):
    ...
    def test_delete_schematics_workspace_failed(self):
        """Test the "delete" path - failed."""
        patcher = patch('ansible.modules.cloud.ibm.schematics_schematics_workspace.SchematicsV1.delete_workspace')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='Delete schematics_workspace error')
        ...
        assert result.exception.args[0]['msg'] == 'Delete schematics_workspace error'
