...
from ansible.modules.cloud.ibm import ibm_iam_access_group_rules_info
...
class TestRulesListModuleInfo(ModuleTestCase):
    ...
    def test_list_ibm_iam_access_group_rules_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_iam_access_group_rules_info.IamAccessGroupsV2.list_access_group_rules')
        mock = patcher.start()
