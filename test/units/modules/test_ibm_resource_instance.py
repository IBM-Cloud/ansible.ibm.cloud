...
from ansible.modules.cloud.ibm import ibm_resource_instance
...
class TestResourceInstancePostModule(ModuleTestCase):
    ...
    def test_read_ibm_resource_instance_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_instance.ResourceControllerV2.get_resource_instance')
        mock = patcher.start()
    ...
    def test_create_ibm_resource_instance_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_instance.ResourceControllerV2.create_resource_instance')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)

        get_resource_instance_patcher = patch('ansible.modules.cloud.ibm.ibm_resource_instance.ResourceControllerV2.get_resource_instance')
    ...
    def test_create_ibm_resource_instance_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_instance.ResourceControllerV2.create_resource_instance')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='Create ibm_resource_instance error')
    ...
    def test_update_ibm_resource_instance_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_instance.ResourceControllerV2.update_resource_instance')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)

        get_resource_instance_patcher = patch('ansible.modules.cloud.ibm.ibm_resource_instance.ResourceControllerV2.get_resource_instance')
        get_resource_instance_mock = get_resource_instance_patcher.start()
        get_resource_instance_mock.return_value = DetailedResponseMock(resource)
        ...
        get_resource_instance_processed_result = post_process_result(get_resource_instance_mock_data, get_resource_instance_mock.call_args.kwargs)
    ...
    def test_update_ibm_resource_instance_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_instance.ResourceControllerV2.update_resource_instance')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='Update ibm_resource_instance error')
    ...
    def test_delete_ibm_resource_instance_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_instance.ResourceControllerV2.delete_resource_instance')
        mock = patcher.start()
    ...
    def test_delete_ibm_resource_instance_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_instance.ResourceControllerV2.delete_resource_instance')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='Delete ibm_resource_instance error')
