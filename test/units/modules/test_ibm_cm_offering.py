...
from ansible.modules.cloud.ibm import ibm_cm_offering
...
class TestOfferingModule(ModuleTestCase):
    ...
    def test_read_ibm_cm_offering_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_offering.CatalogManagementV1.get_offering')
        mock = patcher.start()
    ...
    def test_create_ibm_cm_offering_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_offering.CatalogManagementV1.create_offering')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)

        get_offering_patcher = patch('ansible.modules.cloud.ibm.ibm_cm_offering.CatalogManagementV1.get_offering')
    ...
    def test_create_ibm_cm_offering_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_offering.CatalogManagementV1.create_offering')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='Create ibm_cm_offering error')
    ...
    def test_update_ibm_cm_offering_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_offering.CatalogManagementV1.update_offering')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)
        ...
        get_offering_processed_result = post_process_result(get_offering_mock_data, get_offering_mock.call_args.kwargs)
    ...
    def test_update_ibm_cm_offering_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_offering.CatalogManagementV1.update_offering')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='Update ibm_cm_offering error')
    ...
    def test_delete_ibm_cm_offering_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_offering.CatalogManagementV1.delete_offering')
        mock = patcher.start()
    ...
    def test_delete_ibm_cm_offering_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_offering.CatalogManagementV1.delete_offering')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='Delete ibm_cm_offering error')
