...
from ansible.modules.cloud.ibm import ibm_resource_instances_info
...
class TestResourceInstancesListModuleInfo(ModuleTestCase):
    ...
    def test_list_ibm_resource_instances_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_instances_info.ResourceControllerV2.list_resource_instances')
        mock = patcher.start()
    ...
    def test_list_ibm_resource_instances_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_instances_info.ResourceControllerV2.list_resource_instances')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='List ibm_resource_instances error')
