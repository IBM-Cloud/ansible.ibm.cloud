...
from ansible.modules.cloud.ibm import ibm_iam_service_id
...
class TestServiceIdModule(ModuleTestCase):
    ...
    def test_read_ibm_iam_service_id_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_iam_service_id.IamIdentityV1.get_service_id')
        mock = patcher.start()
    ...
    def test_create_ibm_iam_service_id_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_iam_service_id.IamIdentityV1.create_service_id')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)

        get_service_id_patcher = patch('ansible.modules.cloud.ibm.ibm_iam_service_id.IamIdentityV1.get_service_id')
    ...
    def test_update_ibm_iam_service_id_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_iam_service_id.IamIdentityV1.update_service_id')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)
    ...
    def test_delete_ibm_iam_service_id_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_iam_service_id.IamIdentityV1.delete_service_id')
        mock = patcher.start()
