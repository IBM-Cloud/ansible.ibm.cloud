...
from ansible.modules.cloud.ibm import ibm_cm_version
...
class TestVersionModule(ModuleTestCase):
    ...
    def test_read_ibm_cm_version_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_version.CatalogManagementV1.get_version')
        mock = patcher.start()
    ...
    def test_create_ibm_cm_version_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_version.CatalogManagementV1.import_offering_version')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)

        get_version_patcher = patch('ansible.modules.cloud.ibm.ibm_cm_version.CatalogManagementV1.get_version')
    ...
    def test_delete_ibm_cm_version_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_version.CatalogManagementV1.delete_version')
        mock = patcher.start()
