...
from ansible.modules.cloud.ibm import ibm_resource_key_info
...
class TestResourceKeyModuleInfo(ModuleTestCase):
    ...
    def test_read_ibm_resource_key_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_key_info.ResourceControllerV2.get_resource_key')
        mock = patcher.start()
