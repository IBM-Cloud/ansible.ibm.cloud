...
from ansible.modules.cloud.ibm import ibm_iam_service_ids_info
...
class TestServiceIdListModuleInfo(ModuleTestCase):
    ...
    def test_read_ibm_iam_service_ids_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_iam_service_ids_info.IamIdentityV1.get_service_id')
        mock = patcher.start()
    ...
    def test_list_ibm_iam_service_ids_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_iam_service_ids_info.IamIdentityV1.list_service_ids')
        mock = patcher.start()
