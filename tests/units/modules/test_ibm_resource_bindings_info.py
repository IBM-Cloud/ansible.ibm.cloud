...
from ansible.modules.cloud.ibm import ibm_resource_bindings_info
...
class TestResourceBindingsListModuleInfo(ModuleTestCase):
    ...
    def test_list_ibm_resource_bindings_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_bindings_info.ResourceControllerV2.list_resource_bindings')
        mock = patcher.start()
    ...
    def test_list_ibm_resource_bindings_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_bindings_info.ResourceControllerV2.list_resource_bindings')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='List ibm_resource_bindings error')
