...
from ansible.modules.cloud.ibm import ibm_schematics_inventory
...
class TestInventoryResourceRecordModule(ModuleTestCase):
    ...
    def test_read_ibm_schematics_inventory_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_inventory.SchematicsV1.get_inventory')
        mock = patcher.start()
    ...
    def test_create_ibm_schematics_inventory_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_inventory.SchematicsV1.create_inventory')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)

        get_inventory_patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_inventory.SchematicsV1.get_inventory')
    ...
    def test_update_ibm_schematics_inventory_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_inventory.SchematicsV1.replace_inventory')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)
    ...
    def test_delete_ibm_schematics_inventory_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_inventory.SchematicsV1.delete_inventory')
        mock = patcher.start()
