...
from ansible.modules.cloud.ibm import schematics_schematics_resource_query
...
class TestResourceQueryRecordModule(ModuleTestCase):
    ...
    def test_read_schematics_resource_query_failed(self):
        """Test the inner "read" path in this module with a server error response."""

        patcher = patch('ansible.modules.cloud.ibm.schematics_schematics_resource_query.SchematicsV1.get_resources_query')
        mock = patcher.start()
        ...
        with self.assertRaises(AnsibleFailJson) as result:
            ...
            schematics_schematics_resource_query.main()
    ...
    def test_create_schematics_resource_query_success(self):
        """Test the "create" path - successful."""
        resource_query_param_model = dict(
            name='testString',
            value='testString',
            description='testString',
        )

        resource_query_model = dict(
        ...
        patcher = patch('ansible.modules.cloud.ibm.schematics_schematics_resource_query.SchematicsV1.create_resource_query')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)

        get_resources_query_patcher = patch('ansible.modules.cloud.ibm.schematics_schematics_resource_query.SchematicsV1.get_resources_query')
    ...
    def test_create_schematics_resource_query_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.schematics_schematics_resource_query.SchematicsV1.create_resource_query')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='Create schematics_resource_query error')
        ...
        assert result.exception.args[0]['msg'] == 'Create schematics_resource_query error'
    ...
    def test_update_schematics_resource_query_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.schematics_schematics_resource_query.SchematicsV1.replace_resources_query')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)
        ...
        get_resources_query_processed_result = post_process_result(get_resources_query_mock_data, get_resources_query_mock.call_args.kwargs)
        assert get_resources_query_mock_data == get_resources_query_processed_result
        get_resources_query_patcher.stop()
        patcher.stop()

    def test_update_schematics_resource_query_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.schematics_schematics_resource_query.SchematicsV1.replace_resources_query')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='Update schematics_resource_query error')
        ...
        assert result.exception.args[0]['msg'] == 'Update schematics_resource_query error'
    ...
    def test_delete_schematics_resource_query_success(self):
        """Test the "delete" path - successfull."""
        patcher = patch('ansible.modules.cloud.ibm.schematics_schematics_resource_query.SchematicsV1.delete_resources_query')
        mock = patcher.start()
    ...
    def test_delete_schematics_resource_query_not_exists(self):
    ...
    def test_delete_schematics_resource_query_failed(self):
        """Test the "delete" path - failed."""
        patcher = patch('ansible.modules.cloud.ibm.schematics_schematics_resource_query.SchematicsV1.delete_resources_query')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='Delete schematics_resource_query error')
        ...
        assert result.exception.args[0]['msg'] == 'Delete schematics_resource_query error'
