...
from ansible.modules.cloud.ibm import ibm_schematics_workspace_info
...
class TestWorkspaceResponseModuleInfo(ModuleTestCase):
    ...
    def test_read_ibm_schematics_workspace_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_workspace_info.SchematicsV1.get_workspace')
        mock = patcher.start()
