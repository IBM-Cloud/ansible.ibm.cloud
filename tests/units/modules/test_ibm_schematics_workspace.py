...
from ansible.modules.cloud.ibm import ibm_schematics_workspace
...
class TestWorkspaceResponseModule(ModuleTestCase):
    ...
    def test_read_ibm_schematics_workspace_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_workspace.SchematicsV1.get_workspace')
        mock = patcher.start()
    ...
    def test_create_ibm_schematics_workspace_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_workspace.SchematicsV1.create_workspace')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)

        get_workspace_patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_workspace.SchematicsV1.get_workspace')
    ...
    def test_update_ibm_schematics_workspace_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_workspace.SchematicsV1.update_workspace')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)
    ...
    def test_delete_ibm_schematics_workspace_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_workspace.SchematicsV1.delete_workspace')
        mock = patcher.start()
