...
from ansible.modules.cloud.ibm import ibm_resource_alias_info
...
class TestResourceAliasModuleInfo(ModuleTestCase):
    ...
    def test_read_ibm_resource_alias_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_alias_info.ResourceControllerV2.get_resource_alias')
        mock = patcher.start()
    ...
    def test_read_ibm_resource_alias_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_resource_alias_info.ResourceControllerV2.get_resource_alias')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='Read ibm_resource_alias error')
