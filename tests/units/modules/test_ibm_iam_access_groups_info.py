...
from ansible.modules.cloud.ibm import ibm_iam_access_groups_info
...
class TestGroupsListModuleInfo(ModuleTestCase):
    ...
    def test_list_ibm_iam_access_groups_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_iam_access_groups_info.IamAccessGroupsV2.list_access_groups')
        mock = patcher.start()
    ...
    def test_list_ibm_iam_access_groups_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_iam_access_groups_info.IamAccessGroupsV2.list_access_groups')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='List ibm_iam_access_groups error')
