...
from ansible.modules.cloud.ibm import ibm_schematics_action_info
...
class TestActionModuleInfo(ModuleTestCase):
    ...
    def test_read_ibm_schematics_action_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_action_info.SchematicsV1.get_action')
        mock = patcher.start()
    ...
    def test_read_ibm_schematics_action_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_action_info.SchematicsV1.get_action')
        mock = patcher.start()
        mock.side_effect = ApiException(400, message='Read ibm_schematics_action error')
