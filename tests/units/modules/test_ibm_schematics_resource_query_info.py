...
from ansible.modules.cloud.ibm import ibm_schematics_resource_query_info
...
class TestResourceQueryRecordModuleInfo(ModuleTestCase):
    ...
    def test_read_ibm_schematics_resource_query_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_resource_query_info.SchematicsV1.get_resources_query')
        mock = patcher.start()
