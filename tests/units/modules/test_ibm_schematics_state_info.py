...
from ansible.modules.cloud.ibm import ibm_schematics_state_info
...
class TestTemplateStateStoreModuleInfo(ModuleTestCase):
    ...
    def test_list_ibm_schematics_state_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_state_info.SchematicsV1.get_workspace_template_state')
        mock = patcher.start()
