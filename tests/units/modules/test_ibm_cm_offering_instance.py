...
from ansible.modules.cloud.ibm import ibm_cm_offering_instance
...
class TestOfferingInstanceModule(ModuleTestCase):
    ...
    def test_read_ibm_cm_offering_instance_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_offering_instance.CatalogManagementV1.get_offering_instance')
        mock = patcher.start()
    ...
    def test_create_ibm_cm_offering_instance_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_offering_instance.CatalogManagementV1.create_offering_instance')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)

        get_offering_instance_patcher = patch('ansible.modules.cloud.ibm.ibm_cm_offering_instance.CatalogManagementV1.get_offering_instance')
    ...
    def test_update_ibm_cm_offering_instance_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_offering_instance.CatalogManagementV1.put_offering_instance')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)
    ...
    def test_delete_ibm_cm_offering_instance_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_offering_instance.CatalogManagementV1.delete_offering_instance')
        mock = patcher.start()
