...
from ansible.modules.cloud.ibm import ibm_schematics_action
...
class TestActionModule(ModuleTestCase):
    ...
    def test_read_ibm_schematics_action_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_action.SchematicsV1.get_action')
        mock = patcher.start()
    ...
    def test_create_ibm_schematics_action_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_action.SchematicsV1.create_action')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)

        get_action_patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_action.SchematicsV1.get_action')
    ...
    def test_update_ibm_schematics_action_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_action.SchematicsV1.update_action')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)
    ...
    def test_delete_ibm_schematics_action_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_action.SchematicsV1.delete_action')
        mock = patcher.start()
