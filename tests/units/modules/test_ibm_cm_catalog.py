...
from ansible.modules.cloud.ibm import ibm_cm_catalog
...
class TestCatalogModule(ModuleTestCase):
    ...
    def test_read_ibm_cm_catalog_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_catalog.CatalogManagementV1.get_catalog')
        mock = patcher.start()
    ...
    def test_create_ibm_cm_catalog_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_catalog.CatalogManagementV1.create_catalog')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)

        get_catalog_patcher = patch('ansible.modules.cloud.ibm.ibm_cm_catalog.CatalogManagementV1.get_catalog')
    ...
    def test_update_ibm_cm_catalog_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_catalog.CatalogManagementV1.replace_catalog')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)
    ...
    def test_delete_ibm_cm_catalog_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_cm_catalog.CatalogManagementV1.delete_catalog')
        mock = patcher.start()
