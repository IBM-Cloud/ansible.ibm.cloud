...
from ansible.modules.cloud.ibm import ibm_schematics_job
...
class TestJobModule(ModuleTestCase):
    ...
    def test_read_ibm_schematics_job_failed(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_job.SchematicsV1.get_job')
        mock = patcher.start()
    ...
    def test_create_ibm_schematics_job_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_job.SchematicsV1.create_job')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)

        get_job_patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_job.SchematicsV1.get_job')
    ...
    def test_update_ibm_schematics_job_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_job.SchematicsV1.update_job')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)
    ...
    def test_delete_ibm_schematics_job_success(self):
        ...
        patcher = patch('ansible.modules.cloud.ibm.ibm_schematics_job.SchematicsV1.delete_job')
        mock = patcher.start()
