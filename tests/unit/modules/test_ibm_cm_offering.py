...
class TestOfferingModule(ModuleTestCase):
    ...
    def test_read_ibm_cm_offering_failed(self):
        ...
        patcher = patch('plugins.modules.ibm_cm_offering.CatalogManagementV1.get_offering')
        mock = patcher.start()
    ...
    def test_create_ibm_cm_offering_success(self):
        ...
        patcher = patch('plugins.modules.ibm_cm_offering.CatalogManagementV1.create_offering')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)

        get_offering_patcher = patch('plugins.modules.ibm_cm_offering.CatalogManagementV1.get_offering')
    ...
    def test_update_ibm_cm_offering_success(self):
        ...
        patcher = patch('plugins.modules.ibm_cm_offering.CatalogManagementV1.update_offering')
        mock = patcher.start()
        mock.return_value = DetailedResponseMock(resource)
    ...
    def test_delete_ibm_cm_offering_success(self):
        ...
        patcher = patch('plugins.modules.ibm_cm_offering.CatalogManagementV1.delete_offering')
        mock = patcher.start()
